...
global.owner = [process.env.OWNER_NUMBER] || ['94768372339'] // Owner number , (අයිතිකරුගේ නම්බර් එක )

module.exports = {    
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=uM0kVJLZ#CES7nL1GBmNZgeMlqQDuyYlQeROq_cbt02bp8jMtnG4',
...
WORK_TYPE: process.env.WORK_TYPE || 'groups'  ,
ANTI_LINK: process.env.ANTI_LINK || false  ,
ANTI_BOT: process.env.ANTI_BOT || false  ,
OWNER_NUMBER: process.env.OWNER_NUMBER || '94768372339'  ,    
ALIVE: process.env.ALIVE || `default`,
OWNER_NAME: process.env.OWNER_NAME || 'ANUHAS' ,     
